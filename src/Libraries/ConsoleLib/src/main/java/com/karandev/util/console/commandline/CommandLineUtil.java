...
public final class CommandLineUtil {
    ...
    {
        checkLengthEquals(length, count, message);
    }
    ...
    {
        checkLengthGreater(length, count, message);
    }
    ...
    {
        checkLengthLess(length, count, message);
    }
    ...
    {
        checkLengthLessOrEquals(length, count, message);
    }
    ...
    {
        checkLengthGreaterOrEquals(length, count, message);
    }
